                                    	...
                                    	<div class="col-md-12 col-sm-12 col-xs-12">
                                          ...
                                          <div class="col-md-12 col-sm-12 col-xs-12">
                                           <label>Description</label>
                                            <textarea  name="despc" rows="2" class="form-control" readonly><?php echo $despc?></textarea>
                                          </div>                                       				
                        	...
                        	<div class="col-md-6 col-sm-6 col-xs-12 well">
                                ...
                                <div class="row">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
									  ...
									  <div class="col-md-12 col-sm-12 col-xs-12">
										<label style="float:left">Date</label>
										<input type="text"  name="rdate"  class="form-control" value="<?php echo date("Y-m-d");?>" readonly>
									</div>	  
                                 </div>
