        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Feedback Send</h3>
            </div>
         	  ...
         	  <div class="box-body no-padding">
				 <div class="box-body">
                  ...
                  <tbody>	
                	 <?php
						$result = $db->prepare("select * from feedback where stat='Pending'");
						$result->execute();
						...
						echo"<tr>";
						 ...
						 ?>
						<td>
							<a href="feedback_send.php<?php echo '?fdbk_id='.$fdbk_id;?>" class=" btn btn-sm btn-info">&nbsp;Send</a>  
						</td>    								                           
					   <?php																												
					   echo"</tr>";
					   }						
