...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2024 at 03:48 PM
...
--
ALTER TABLE `turf`
  MODIFY `turfid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `turf_register`
--
ALTER TABLE `turf_register`
  MODIFY `turfrid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
