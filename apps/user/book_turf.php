              ...
              <div class="box box-danger">            
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
                       ...
                       <!-- Col Start -->
                       <?php
                        $result = $db->prepare("select * from trcart where CLog_Id='$Log_Id'");
                        $result->execute();
                        $row_count =  $result->rowcount();
                        for($i=0; $rows = $result->fetch(); $i++)
                        {
							$turfrid = $rows['cart_id'];
							?>
                           <div class="col-md-4">
                              ...
                              <div class="box box-widget widget-user">
                                ...
                                <div class="widget-user-header bg-aqua-active">
                                  ...
                                  <h5 class="widget-user-desc"><?php echo $rows['saddr'];?></h5>
                                   <h5 class="widget-user-desc"><?php echo $rows['scntno'];?></h5>
                                ...
                                <div class="box-footer">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="description-block">
                                        <h5 class="description-header"><?php echo date("m-d",strtotime($rows['dat']));?></h5>
