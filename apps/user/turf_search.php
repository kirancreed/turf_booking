              ...
              <div class="box box-danger">            
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
                       ...
                       <!-- Col Start -->
                       <?php
                        $result = $db->prepare("select * from turf_register");
                        $result->execute();
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4 border-right">
                                      <div class="description-block">
                                        ...
                                        <span class="description-text">CAPACTITY</span>
                                      </div>
                                      <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-4">
                                      <div class="description-block">
                                      <a href="turf_search_book.php<?php echo '?turfrid='.$turfrid; ?>" class="btn btn-block btn-primary">Book</a>
                                      </div>
                                      <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
